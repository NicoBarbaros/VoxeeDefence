...
public class JoyStickScript : MonoBehaviour
{
    ...
    */
	...
	private static List<JoyStickScript> joysticks;
	...
	private void Awake()
	{
		...
		if (!enumeratedJoysticks)
		{
			try
			{
				...
				joysticks = new List<JoyStickScript>(objs.Length);
				foreach (GameObject obj in objs)
				{
					JoyStickScript newJoystick = obj.GetComponent<JoyStickScript>();
					if (newJoystick == null)
					{
	...
	//Todo - Create a function that shows the GUI in time
	public void ToogleGUI(float alphaValue)
	{
			...
			for (int i = 0; i < count; i++)
			{
				...
				if (lastFingerId == touch.fingerId)
				{
                    ...
                    */
					...
					//Takes the last moment of the touch
					if (touch.phase == TouchPhase.Ended || touch.phase == TouchPhase.Canceled)
					{
						Restart();
					}

					//Takes the first Frame of the touch
